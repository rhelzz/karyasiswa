...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT * FROM absensi WHERE username LIKE '%$query%' OR class LIKE '%$query%' OR status_kehadiran LIKE '%$query%' OR hari LIKE '%$query%'";
        ...
        <div class="main p-3">
            <div class="absen">
                ...
                <div class="container mt-5">
                    ...
                    <div class="d-flex">
                        <a href="../tabeldata.php" class="btn text-white mb-4" style="background-color: #0e2238;">Kembali</a>
                    </div>
