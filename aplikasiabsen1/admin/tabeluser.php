...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            ...
            <form class="d-flex mx-auto mt-5 w-25 form-group" action="controller/searchuser.php" method="GET">
            ...
            <h1 class="text-center mb-4 mt-5">Data User</h1>
                <table id="singleDataRow" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, username, email, class, created_at FROM users";
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <a href='controller/edituser.php?id=" . $row['id'] . "' class='btn btn-secondary'>Edit</a>
                                        <a href='controller/deleteuser.php?id=" . $row['id'] . "' class='btn btn-secondary'>Delete</a>
                                    </td>";
                                echo "</tr>";
                            }
                        } else {
